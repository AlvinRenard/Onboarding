  ...
  {{ csrf_field() }}
    ...
    <input type="submit" value="Submit">
        ...
        <td class='action'>
          ...
          <a class="accept" onclick="return confirm('Are you sure?')"href="{{ '/acceptfinancefinal/'.$data['employee']->id.'/'.$data['employee']->token }}">
            Accept
          </a>
          <a class="reject" href="{{ '/rejectfinancelanding/'.$data['employee']->id.'/'.$data['employee']->token }}">
            Reject
          </a>
        </td>
      </tr>
