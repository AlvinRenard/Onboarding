...
<body>
    ...
    <body id="page-top">
        ...
        <header class="masthead" style="background-image:  url('{{asset('images/bg-masthead.jpg')}}')">
            ...
            <a class="btn btn-primary" href="{{ '/home' }}">Return to Homepage</a>
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">File submission not complete!</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">it Means that the employee haven't uploaded one of the required files </p>
                        <a class="btn btn-primary"href="{{'/reset/'.$data['employee']->id.'/'.$data['employee']->token}}">Reset Employee Progress</a></br>
